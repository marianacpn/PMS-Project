...
namespace WebUI.Common
{
    public static class ActionResultExtensions
    {
        ...
        {
            return WithMessage(actionResult, message, WebConst.WEB_CLASS_ALERT_SUCCESS);
        }

        public static IActionResult WithWarningMessage(this IActionResult actionResult, string message)
        {
            return WithMessage(actionResult, message, WebConst.WEB_CLASS_ALERT_WARNING);
        }

        public static IActionResult WithDangerMessage(this IActionResult actionResult, string message)
        {
            return WithMessage(actionResult, message, WebConst.WEB_CLASS_ALERT_DANGER);
        }
